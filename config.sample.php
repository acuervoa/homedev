...
/** directory name(s) */
$dir = array("/Users/andres.cuervo.adame/Sites/*");
...
//    array( 'name' => 'Tool', 'url' => 'http://example.com/' ),
    ...
    array( 'name' => 'Github', 'url' => 'http://github.com/acuervoa’ ),
    );

/*
 *
 *  Options for sites being displayed. These are completely optional, if you dont set
 ...
 *
 *  Otherwise, if you want to set additional options you will use an array for the options.
 *
